...
public class OpenCVTracer
{
	public static BitmapSource CVTrace(string uri)
    {
        ...
        */
        Mat src = new Mat(uri, ImreadModes.Grayscale); //This image would NOT be in color, but we will do the conversion anyways
        ...
        //TODO: Create scrollbar for denoising strength values below
        Cv2.FastNlMeansDenoising(src, clearEdge, 6f);
        //TODO: Create scrollbar for hystersis threshold values below.
        Cv2.Canny(clearEdge, canny, 32, 192);
